...
public class SegmentCacheConfig
{
  @JsonProperty
  ...
  public static SegmentCacheConfig create()
  {
    return new SegmentCacheConfig();
  }
  ...
  {
    SegmentCacheConfig config = new SegmentCacheConfig();
  ...
  public boolean equals(final Object o)
  {
    ...
    final SegmentCacheConfig that = (SegmentCacheConfig) o;
