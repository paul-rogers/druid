...
public class BatchValidator
{
  ...
  public static void assertEquals(RowReader reader1, RowReader reader2)
  {
    forTests().isEqual(reader1, reader2);
  }
  ...
  public static void assertNotEquals(RowReader reader1, RowReader reader2)
  {
    Assert.assertFalse(BatchEquality.simple().isEqual(reader1, reader2));
  }
}
