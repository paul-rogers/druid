...
Usage: $0 cmd [category]
  ...
  up category - Start the cluster
  down category - Stop the cluster
  status category - Status of the cluster (for debugging within build scripts)
  compose-cmd category - Pass the command to Docker compose.
EOF
}
