...
public class TableBuilder
{
  ...
  public static TableBuilder inputTable(String type, String name)
  {
    return new TableBuilder()
        .input(name)
        .type(type);
  ...
  public TableBuilder input(String name)
  {
    this.id = TableId.of(TableId.INPUT_SCHEMA, name);
    return this;
  }
  ...
  {
    return property(DatasourceDefn.ROLLUP_GRANULARITY_FIELD, rollupGranularty);
  }

  public TableBuilder segmentGranularity(String segmentGranularity)
  {
    return property(DatasourceDefn.SEGMENT_GRANULARITY_FIELD, segmentGranularity);
  }

  public TableBuilder clusterColumns(ClusterKeySpec...clusterKeys)
  {
    return property(DatasourceDefn.CLUSTER_KEYS_FIELD, Arrays.asList(clusterKeys));
  }
  ...
  public TableBuilder column(String name, String sqlType)
  {
    ...
    if (isInputTable(tableType)) {
      colType = InputTableDefn.INPUT_COLUMN_TYPE;
  ...
  {
    return property(DatasourceDefn.HIDDEN_COLUMNS_FIELD, hiddenColumns);
  }
  ...
  {
    return property(FormattedInputTableDefn.INPUT_FORMAT_PROPERTY, format);
  }
