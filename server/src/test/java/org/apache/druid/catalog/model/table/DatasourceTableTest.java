...
public class DatasourceTableTest
{
  ...
  public void testWrongTypes()
  {
    ...
    {
      TableSpec spec = TableBuilder.rollupTable("foo", "P1D")
          .property(DatasourceDefn.ROLLUP_GRANULARITY_FIELD, 10)
          .buildSpec();
      expectValidationFails(spec);
    }
    ...
    // Target segment rows
    {
      TableSpec spec = TableBuilder.detailTable("foo", "P1D")
          .property(DatasourceDefn.TARGET_SEGMENT_ROWS_FIELD, "bogus")
          .buildSpec();
      expectValidationFails(spec);
    }
    ...
    {
      TableSpec spec = TableBuilder.detailTable("foo", "P1D")
          .property(DatasourceDefn.HIDDEN_COLUMNS_FIELD, "bogus")
          .buildSpec();
      expectValidationFails(spec);
    }
    {
  ...
  private TableSpec exampleSpec()
  {
    ...
    TableSpec spec = TableBuilder.rollupTable("foo", "PT1H")
        ...
        .rollupGranularity("PT1M")
        .property(DatasourceDefn.TARGET_SEGMENT_ROWS_FIELD, 1_000_000)
