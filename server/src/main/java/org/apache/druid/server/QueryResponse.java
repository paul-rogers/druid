...
public class QueryResponse<T>
{
  ...
  private final ConcurrentResponseContext responseContext;
  ...
  public static <T> QueryResponse<T> create(final Sequence<T> results, final ConcurrentResponseContext responseContext)
  {
