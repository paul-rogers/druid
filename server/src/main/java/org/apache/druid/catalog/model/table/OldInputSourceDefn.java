 ...
 */
public abstract class OldInputSourceDefn extends TableDefn
{
  public static final String EXTERNAL_COLUMN_TYPE = "extern";

  public abstract static class FormattedInputSourceDefn extends OldInputSourceDefn
  {
  ...
  {
    return table.defn() instanceof OldInputSourceDefn;
  }
